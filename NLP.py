...
dataset_train = nlp.data.TSVDataset('C:/projects/NLP/KoBERT/감성대화/labeld_train.tsv', field_indices=[2, 1], num_discard_samples=1)
dataset_test = nlp.data.TSVDataset('C:/projects/NLP/KoBERT/감성대화/labeld_valid.tsv', field_indices=[2, 1], num_discard_samples=1)
